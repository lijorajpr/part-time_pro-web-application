                    ...
                    <div class="card border-0 shadow mb-4 ">
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    <label for="" class="mb-2">Number of Vacancies<span class="req">*</span></label>
                                    <input value="{{ $job->vacancy }}" type="number" min="1" placeholder="Number of Vacancies" id="vacancy" name="vacancy" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    <label for="" class="mb-2">Remuneration</label>
                                    <input value="{{ $job->remuneration }}" type="text" placeholder="Remuneration" id="remuneration" name="remuneration" class="form-control">
                                </div>
