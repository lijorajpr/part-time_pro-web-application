                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6  mb-4">
                                    ...
                                    <input type="number" min="1" placeholder="Number of Vacancies" id="vacancy" name="vacancy" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" placeholder="Remuneration" id="remuneration" name="remuneration" class="form-control">
                                </div>
