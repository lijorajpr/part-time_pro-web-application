    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-xl-8">
                <h1>Find your perfect part-time job, effortlessly.</h1>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-xl-3 col-md-6">
                <div class="single_catagory">
                    ...
                    <p class="mb-0"> <span>{{ $category->jobs_count }}</span> Available positions</p>
                </div>
            </div> 
            @endforeach                
            @endif
                                ...
                                <div class="card border-0 p-3 shadow mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="bg-light p-3 border">
                                            ...
                                            @if (!is_null($latestJob->remuneration))
                                            <p class="mb-0">
                                                <span class="fw-bolder"><i class="fa fa-usd"></i></span>
                                                <span class="ps-1">{{ $latestJob->remuneration }}</span>
                                            </p>
                                            @endif                                            
                                        </div>
